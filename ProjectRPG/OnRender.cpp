...
void Game::OnRender()
{
   ...
   // SDL_RenderDrawLine(Renderer, lineX1, lineY1, lineX2, lineY2);
    ...
    Draw(Kapchica, waterPointer.x, waterPointer.y, waterPointer.w, waterPointer.h, SDL_FLIP_NONE);

    Draw(Kapchica, fertilizePointer.x, fertilizePointer.y, fertilizePointer.w, fertilizePointer.h, SDL_FLIP_NONE);

    ///      Creating animation

    MySun.Animate = Sun.Image;
    MySun.Frames = 4;
    MySun.Height = Sun.Height;
    MySun.Width = Sun.Width;
    ...
    //Draw(Block.Image, Block.XPos, Block.YPos, Block.Width, Block.Height, Block.Flip);*/
