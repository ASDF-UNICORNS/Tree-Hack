...
//    connect = mysql_init(NULL);
  ...
  /*  if(!connect)
    ...
    if((Window = SDL_CreateWindow("Tree Hack", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 640, 480,
   ...
   /* Block.Flip = SDL_FLIP_NONE;
    Block.Image = OnLoad("./images/block.png");
    Block.CreateEntity(50, 50, 96, 96);*/

    //If there was a problem loading the images
